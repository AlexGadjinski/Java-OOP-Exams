...
import static forgottenBattleships.common.ConstantMessages.SHIP_INFO;
...
public abstract class BaseBattleship implements Battleship {
    ...
    public void attack(Battleship battleship) {
        if (ammunition >= hitStrength) {
            decreaseAmmo(hitStrength);
    ...
    public String toString() {
        return SHIP_INFO.formatted(name, health, ammunition);
    }
}
